            ...
            <Fragment>
                ...
                <div className="row f-flex justify-content-around">
                        ...
                        <Carousel pause="hover">
                            {product.images && product.images.length > 0 && product.images.map(image =>
                                <Carousel.Item key={image._id}>
                                    <img className="d-block  product-detail-img"  src={image.image} alt={product.name} height="500" width="500" />
                                </Carousel.Item>
                            )}
                        </Carousel>
                    </div>

                    <div className="col-12 col-lg-5 mt-5 product-detail-description">
                    <h3 style={{fontSize:'1.5rem'}}><b>{product.name}</b></h3> 
                    ...
                    <button type="button" id="cart_btn" 
                     ...
                     className="btn btn-primary d-inline ml-4 mb-2"
                     >Add to Cart</button>

                    <hr/> 

                    <p className="mt-2"><b>Status: </b><span className={product.stock > 0 ?'greenColor':'redColor'} id="stock_status">{ product.stock > 0 ?'In Stock':'Out of Stock'}</span></p>
                    ...
                    <hr/> 
                    <p className="mt-2" id="product_seller mb-3"><b>Sold by: </b> <strong style={{color:'brown'}}>{product.seller}</strong></p>
                    { user ?
                    ...
                    <div className="alert alert-danger mt-5 review-auth" > Login to Post Review</div>
                    }
